/* ============================================================
   AUDIZY — search.js
   Powers search.html: debounced live search hitting /api/search,
   plus the homepage's quick-search box (shared handler).
   ============================================================ */
...
document.addEventListener('DOMContentLoaded', () => {
  if (document.body.dataset.page === 'search') Search.init();
});
